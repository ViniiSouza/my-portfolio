export default {
    en: {
        ...
        knowledge: {
            ...
            techs: {
                cSharp: `Knowledge in classes, OOP (objects, encapsulation, inheritance, polymorphism, abstraction, etc.), partial classes, interfaces, exception handling. Use of Entity Framework working code first (or not), inherited classes, with creation and maintenance of CRUD's, tables, link between tables 1:1, N:1, N:N; Use of LINQ, with performative projections in databases and several other uses. SignalR for seamless connections and real-time updates. Use of external libraries in the projects worked on, etc. API projects, class libraries, console, windows forms, etc.`,
                vue: `Component creation and maintenance, route management, HTTP requests, conditional rendering, dynamic components, component styling, properties, methods, directives, vuex, and other integrations with the backend; Daily use of CompositionAPI and OptionsAPI; Vue2 and knowledge in Vue3;`,
                javaScript: `Functions, classes, loops, conditions, destructuring, DOM manipulations, axios and other general uses along with the frameworks I use.`,
                sql: `Database manipulations, tables, columns and data. Filters in general, table relationships, primary and foreign keys, joins, etc.`,
                react: `Knowledge in components, props, conditional rendering, events, hooks, contextAPI, react-router-dom, forms with formik, yup, etc.`,
                bootstrap: `Using bootstrap elements, styling single elements, using bootstrap classes for document styling, using joint libraries (vue-bootstrap, angular-bootstrap), etc.`,
                html: `Structures with semantic tags, form creations, accessibility, etc.`,
                css: `Element styling, animations, pseudo-elements, advanced selectors, media queries, etc.`,
                typeScript: `Uses with Angular with component management, method creations, etc.`,
                angular: `Knowledge in component creation and maintenance, route management, SPA, HTTP requests, ngModel, etc.`,
            }
        },
        home: {
    ...
    pt: {
        ...
        knowledge: {
            ...
            techs: {
                cSharp: `Conhecimento em classes, POO (objetos, encapsulamento, herança, polimorfismo, abstração, etc), partial classes, interfaces, tratamento de exceções. Uso do Entity Framework trabalhando code first(ou não), classes herdadas, com criação e manutenção de CRUD's, tabelas, vínculo entre tabelas 1:1, N:1, N:N; Uso do LINQ, com projeções performáticas em bancos de dados e diversos outros usos. SignalR para conexões contínuas e atualizações em tempo real. Uso de bibliotecas externas nos projetos trabalhados, etc. Projetos de API, bibliotecas de classes, console, windows forms, etc.`,
                vue: `Criação e manutenção de componentes, gerenciamento de rotas, requisições HTTP, renderizações condicionais, componentes dinâmicos, estilizações de componentes, propriedades, métodos, diretivas, vuex, e demais integrações com o backend; Uso diário de CompositionAPI e OptionsAPI; Vue2 e conhecimentos em Vue3;`,
                javaScript: `Funções, classes, loops, condições, destructuring, manipulações de DOM, axios e outros usos gerais juntamente com os frameworks que utilizo.`,
                sql: `Manipulações de banco de dados, tabelas, colunas e dados. Filtros em geral, relacionamento de tabelas, chaves primárias e estrangeiras, joins, etc`,
                react: `Conhecimento em componentes, props, renderização condicional, eventos, hooks, contextAPI, react-router-dom, formulários com formik, yup, etc.`,
                bootstrap: `Utilização de elementos bootstrap, estilizações de elementos únicos, utilização de classes bootstrap para estilização do documento, utilização de bibliotecas conjuntas (vue-bootstrap, angular-bootstrap), etc.`,
                html: `Estruturas com tags semânticas, criações de formulários, acessibilidade, etc.`,
                css: `Estilizações de elementos, animações, pseudo-elementos, seletores avançados, media queries, etc.`,
                typeScript: `Usos junto ao Angular com gerenciamento de componentes, criações de métodos, etc.`,
                angular: `Conhecimento em criação e manutenção de componentes, gerenciamento de rotas, SPA, requisições HTTP, ngModel, etc.`,
            }
        },
        home: {
